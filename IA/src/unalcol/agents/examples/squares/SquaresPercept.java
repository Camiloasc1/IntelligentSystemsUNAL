...
public class SquaresPercept extends Percept
{
    ...
    public Object getAttribute(String code)
    {
        ...
        {
            if (code.equals(Squares.WHITE + "_" + Squares.TIME))
                return clock.white_time_string();
            if (code.equals(Squares.BLACK + "_" + Squares.TIME))
                return clock.black_time_string();
            if (code.equals(Squares.SIZE))
            ...
            {
                if ((board.values[i][j] & Board.WHITE) == Board.WHITE)
                    return Squares.BLACK;
                return Squares.WHITE;
            }
            else
