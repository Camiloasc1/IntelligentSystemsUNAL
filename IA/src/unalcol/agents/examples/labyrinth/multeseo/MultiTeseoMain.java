...
import unalcol.agents.examples.labyrinth.multeseo.simple.SimpleTeseoCompetitorAgentProgram;
import unalcol.agents.examples.labyrinth.multeseo.simple.TeseoCompetitor;
...
public class MultiTeseoMain {
  ...
  public static void main( String[] argv ){
    ...
    int index1 = 0;
    int index2 = 2;
    teseo[0] = new RandomReflexTeseo(); 
    ((RandomReflexTeseo)teseo[0]).setLanguage(getLanguage());
    teseo[1] = new RandomReflexTeseo(); 
    ((RandomReflexTeseo)teseo[1]).setLanguage(getLanguage());
    teseo[2] = new TeseoCompetitor( getLanguage() ); 
