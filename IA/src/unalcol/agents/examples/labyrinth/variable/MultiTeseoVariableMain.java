...
import unalcol.agents.examples.labyrinth.SII_20152.minotauro.LabyrinthAgent;
...
public class MultiTeseoVariableMain
{
    private static SimpleLanguage getLanguage()
    {
        ...
        { "front", "right", "back", "left", "exit", "fail", "afront", "aright", "aback", "aleft" }, new String[]
    ...
    public static void main(String[] argv)
    {
        ...
        teseo[2] = new RandomReflexTeseo(getLanguage());
        teseo[3] = new RandomReflexTeseo(getLanguage());
